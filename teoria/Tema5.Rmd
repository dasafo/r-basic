...
```{r}
# students = read.table(textConnection(getURL("https://www.public.iastate.edu/~maitra/stat501/datasets/morel.dat")),
...
```{r}
students = read.table("../data/morel.dat", 
  col.names = c("technicalDisciplines","aptitude","maths", "language", "generalKnowledge"))
