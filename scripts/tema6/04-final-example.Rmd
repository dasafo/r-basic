...
ftable(HairEyeColor)
male <- HairEyeColor[, ,"Male"] #extraemos todos los colores de pelo y de ojos para los hombres
female <- HairEyeColor[, ,"Female"] #extraemos todos los colores de pelo y de ojos para las mujeres
data <- as.table(male+female) #sumamos las funciones male y female creadas arriba
data
```
