...
row.names(df5) = c("P1", "P2", "P3", "P4", "P5") #elegimos el nombre de las filas
df5
str(df5)
dimnames(df5) = list(
...
df5
df5$Sexo = as.character(df5$Sexo) #hacemos un castin
...
str(df_m)
df_m = droplevels(df_m) #eliminamos los niveles sobrantes que arrastramos
str(df_m)
```
...
rownames(versicolor) = 1:nrow(versicolor) #cambiamos el nombre de las filas a las del nuevo dataset
head(versicolor, 5)
str(versicolor)
```
